...
class IfEnterSpider(CrawlSpider):
    name = 'ifenter'
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(IfEnterSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def parse_detail(self, response):
        ...
        req_url = urls[0] + "&uid=128783652&sign=6c77656051968e551b8be609c9b64cb53c0cf3cabe27a03762cbbf1a76c370fd_14863f03ee1f1be55173ccc57a80b084&token=bcf754f7d05d48629f6011d644d68b13&gid=1"
