...
class Ifvod2Spider(scrapy.Spider):
    ...
    #     start_urls.append('https://www.ifsp.tv/list?keyword=&star=&pageSize=36&cid=0,1,4&year=今年&language=-1&region=-1&status=-1&orderBy=2&desc=true&page=' + str(i))
    ...
    for i in range(1, 9, 1):
        start_urls.append(
            'https://www.ifsp.tv/list?keyword=&star=&pageSize=36&cid=0,1,4&year=今年&language=-1&region=-1&status=-1&orderBy=1&desc=true&page=' + str(
                i))
